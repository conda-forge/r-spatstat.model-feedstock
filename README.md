...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-spatstat.model-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-spatstat.model-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-spatstat.model
# for installing globally
pixi global install r-spatstat.model
```
...
It is possible to list all of the versions of `r-spatstat.model` available on your platform:
...
```
pixi search r-spatstat.model --channel conda-forge
```
